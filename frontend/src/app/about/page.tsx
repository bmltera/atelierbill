        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24 md:gap-12">
          {team.map((member) => (
            <div key={member.id}>
              ...
              >
                <h3 className="text-[clamp(2.5rem,6vw,5rem)] font-extralight tracking-tight uppercase mb-5 text-white/80 group-hover:text-white/95 transition-colors duration-200">
                  {member.name}
                </h3>
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="flex items-center gap-2 text-white/30 group-hover:text-white/50 transition-colors duration-200">
